    ...
    <div class="grid grid-cols-3">
        ...
        <div class="col-start-1 col-span-2">
            ...
            @foreach($pregunta1 as $preferencia)
                <div class="mt-2">
                    <input type="checkbox" id="{{$preferencia['nombre']}}" name="{{$preferencia['nombre']}}" value="{{ $preferencia['id'] }}">
...
function submitForm() {
    // Collect form data
    let formData = new FormData(document.getElementById('userPreferencesForm'));

    // Send data to Livewire method
    Livewire.emit('submitFormData', formData);
};
</script>
@endscript
